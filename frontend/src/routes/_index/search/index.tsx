...
import { CarryOutOutlined, CloudDownloadOutlined, CopyOutlined, HistoryOutlined, RedoOutlined, UserOutlined, SearchOutlined } from "@ant-design/icons";
                    ...
                    items={[
                        {
                            ...
                            children: (
                                <WebActorSearch onVideoSelect={handleWebVideoSelect} />
                            ),
                        },
                        {
                            key: 'video',
