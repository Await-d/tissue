import{W as h,F as r,am as f,as as d,at as x,b1 as g,au as $,aO as b,aC as p,aQ as k,av as c,S as j,ad as P,J as y,aE as v,Y as w,aG as S,V as C,U as z,N as m,ag as I}from"./index-BqYHbufV.js";function B(e){const{form:i,initValues:l,...s}=e,o=h();return r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
            ...
            `}),r.jsx(f,{...s,title:l.name,className:"site-modify-modal",children:r.jsxs(d,{form:i,layout:"vertical",children:[r.jsx(d.Item,{noStyle:!0,name:"id",children:r.jsx(x,{style:{display:"none"}})}),r.jsx(d.Item,{name:"alternate_host",label:"替代域名",children:r.jsx(x,{placeholder:"当域名失效或替代域名时填写"})}),r.jsx(d.Item,{name:"priority",label:"优先级",initialValue:0,children:r.jsx(g,{children:Array(101).fill(0).map((n,a)=>r.jsx(g.Option,{value:a,children:a},a))})}),r.jsx(d.Item,{name:"status",label:"状态",valuePropName:"checked",children:r.jsx($,{children:"启用"})})]})})]})}async function E(){return(await b.get("/site/")).data}function F(e){return b.put("/site/",e)}function N(){return b.post("/site/testing")}function O(){const e=h(),{data:i,refresh:l,loading:s}=p(E,{}),{modalProps:o,setOpen:n}=k({service:F,onOk:()=>{n(!1),l()}}),{run:a}=p(N,{manual:!0,onSuccess:()=>{I.success("站点刷新提交成功")}});function u(t){return r.jsx(y.Item,{children:r.jsx(C.Ribbon,{text:t.status?"启用":"停用",color:t.status?e.goldPrimary:e.textTertiary,style:{fontSize:"12px",fontWeight:500},children:r.jsx(c,{size:"default",title:r.jsxs("div",{className:"flex items-center gap-2",children:[r.jsx(m,{style:{background:e.rgba("gold",.15),color:e.goldPrimary,border:`1px solid ${e.borderGold}`,fontWeight:600,minWidth:"32px",textAlign:"center"},children:t.priority}),r.jsx("div",{style:{color:e.textPrimary,fontWeight:500},children:t.name})]}),className:"cursor-pointer site-card",onClick:()=>n(!0,t),style:{background:e.bgContainer,border:`1px solid ${e.borderPrimary}`,boxShadow:`0 2px 8px ${e.rgba("black",.3)}`,transition:"all 0.3s cubic-bezier(0.4, 0, 0.2, 1)",overflow:"hidden"},styles:{header:{background:e.bgSpotlight,borderBottom:`1px solid ${e.borderPrimary}`,padding:"12px 16px"},body:{padding:"16px"}},children:r.jsxs(z,{direction:"vertical",size:"large",style:{width:"100%"},children:[r.jsx("div",{style:{color:e.textSecondary,fontSize:"13px",lineHeight:"1.5"},children:r.jsx("span",{children:t.alternate_host||"未设置替代域名"})}),r.jsxs("div",{className:"flex gap-2",children:[r.jsx(m,{style:{background:e.rgba("blue",.15),border:`1px solid ${e.rgba("blue",.3)}`,color:e.info},children:"元数据"}),t.downloadable&&r.jsx(m,{style:{background:e.rgba("green",.15),border:`1px solid ${e.rgba("green",.3)}`,color:e.success},children:"下载"})]})]})})})})}return s?r.jsx(c,{style:{background:e.bgContainer,border:`1px solid ${e.borderPrimary}`},children:r.jsx(j,{active:!0})}):r.jsxs(r.Fragment,{children:[r.jsx("style",{children:`
                .site-card:hover {
