...
def downgrade() -> None:
    # ### 删除 video_cache 表 ###
    op.drop_index('idx_source_type_cycle', table_name='video_cache')
    op.drop_index('idx_release_date', table_name='video_cache')
    op.drop_index('idx_rating', table_name='video_cache')
    op.drop_index('idx_num', table_name='video_cache')
    op.drop_index('idx_fetched_at', table_name='video_cache')
    op.drop_index('idx_comments', table_name='video_cache')
