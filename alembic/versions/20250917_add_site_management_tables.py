...
def downgrade():
    ...
    # 删除索引和表（按依赖关系逆序）
    op.drop_index(op.f('ix_site_load_balancers_name'), table_name='site_load_balancers')
    op.drop_index(op.f('ix_site_load_balancers_id'), table_name='site_load_balancers')
    op.drop_table('site_load_balancers')

    op.drop_index(op.f('ix_site_failover_rules_name'), table_name='site_failover_rules')
    op.drop_index(op.f('ix_site_failover_rules_id'), table_name='site_failover_rules')
    op.drop_table('site_failover_rules')

    op.drop_index(op.f('ix_site_error_logs_error_type'), table_name='site_error_logs')
    op.drop_index(op.f('ix_site_error_logs_occurred_at'), table_name='site_error_logs')
    op.drop_index(op.f('ix_site_error_logs_site_id'), table_name='site_error_logs')
    op.drop_index(op.f('ix_site_error_logs_id'), table_name='site_error_logs')
    op.drop_table('site_error_logs')

    op.drop_index(op.f('ix_site_health_checks_checked_at'), table_name='site_health_checks')
    op.drop_index(op.f('ix_site_health_checks_site_id'), table_name='site_health_checks')
    op.drop_index(op.f('ix_site_health_checks_id'), table_name='site_health_checks')
    op.drop_table('site_health_checks')

    op.drop_index(op.f('ix_site_statistics_site_id'), table_name='site_statistics')
