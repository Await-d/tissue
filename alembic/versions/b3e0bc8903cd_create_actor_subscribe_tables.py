...
def upgrade() -> None:
    ...
    # 只在表不存在时创建 actor_subscribe
    if 'actor_subscribe' not in existing_tables:
    ...
    # 只在表不存在时创建 actor_subscribe_download
    if 'actor_subscribe_download' not in existing_tables:
